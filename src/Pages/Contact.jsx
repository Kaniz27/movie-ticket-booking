  ...
  return (
    <div className="min-h-screen bg-[#0b0e17] text-white px-6 py-12">
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-8 justify-center">
        ...
        {/* LEFT BOX – FORM */}
        <div className="relative bg-[#111827] w-full lg:w-[45%] rounded-xl p-8 shadow-xl">
        ...
        {/* RIGHT BOX – INFO */}
        <div className="relative bg-[#111827] w-full lg:w-[45%] rounded-xl p-8 shadow-xl h-fit">
          <div className="absolute -top-3 left-5 bg-pink-600 text-xs px-4 py-1 rounded-full">
            🍿 CINEMA INFO
          </div>

          <h3 className="text-xl font-semibold mb-5">Contact Information</h3>

          <p className="my-2"><span className="font-semibold">📞 Booking Hotline:</span> +91 8294341275</p>
          <p className="my-2"><span className="font-semibold">📧 Email:</span> bookings@cineplex.com</p>
          <p className="my-2"><span className="font-semibold">📍 Main Theater:</span> 123 Cinema Street, Film City, Mumbai</p>
